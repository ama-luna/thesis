...
missingness_data <- new_fo_cog %>% select(cumul_duration, avg_duration, total_anstat_cases, AgeAtDiagnosis, Geslacht, fo_cog, RT, SCT, CT)
missingness_data <- new_po_tot %>% select(cumul_duration, avg_duration, total_anstat_cases, AgeAtDiagnosis, Geslacht, po_tot, RT, SCT, CT)

dependent <- "fo_cog"
dependent <- "po_tot"
explanatory <- c("AgeAtDiagnosis", "Geslacht", 
                  "RT", "CT", "SCT", "total_anstat_cases", 
                 "avg_duration", "cumul_duration")

missingness_data %>% missing_plot() # For both, only dependent variable missing

mcar_test(missingness_data)
